...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=izanami.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x69, 0x7a, 0x61, 0x6e, 0x61, 0x6d, 0x69, 0x22, 0x2e, 0x0a,
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x69, 0x7a, 0x61, 0x6e, 0x61, 0x6d, 0x69, 0x2e,
	...
	,
}
...
var file_proto_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: izanami.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: izanami.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: izanami.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: izanami.HealthCheckResponse.status:type_name -> izanami.HealthCheckResponse.ServingStatus
	1, // 1: izanami.Health.Check:input_type -> izanami.HealthCheckRequest
	1, // 2: izanami.Health.Watch:input_type -> izanami.HealthCheckRequest
	2, // 3: izanami.Health.Check:output_type -> izanami.HealthCheckResponse
	2, // 4: izanami.Health.Watch:output_type -> izanami.HealthCheckResponse
